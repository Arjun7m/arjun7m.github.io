...
I am a 1st Year [ML PhD student](https://ml.gatech.edu/phd) at the [School of Computational Science and Engineering](https://cse.gatech.edu/) at [Georgia Institute of Technology](https://www.gatech.edu/), where I am advised by [Prof. B Aditya Prakash](https://faculty.cc.gatech.edu/~badityap/) at the [AdityaLab](https://adityalab.cc.gatech.edu/index.html). My research focuses on advancing the scalability, efficiency, and reasoning capabilities of time series foundation models and multimodal AI systems. I am currently working on building truly multivariate time series foundation models, creating more robust and holistic benchmarks for their evaluation, and modelling time series with text for context-aware decision making.

I recently graduated with a [Master's degree](https://www.lti.cs.cmu.edu/people/students/choudhry-arjun.html) at the [Language Technologies Institute](https://www.lti.cs.cmu.edu/) at [Carnegie Mellon University](https://www.cmu.edu/), where I conducted research at the [Auton Lab](https://autonlab.org/) at the [School of Computer Science](https://www.cs.cmu.edu/) under the guidance of [Prof. Artur Dubrawski](https://www.ri.cmu.edu/ri-faculty/artur-w-dubrawski/). At CMU, I worked on
* [MOMENT](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=raSUiKUAAAAJ&citation_for_view=raSUiKUAAAAJ:roLk4NBRz8UC), the first family of open-source time series foundation models
* [JoLT](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=raSUiKUAAAAJ&citation_for_view=raSUiKUAAAAJ:LkGwnXOMwfcC), jointly modelling time series and text for tasks like time series interpretation and summarisation
* [TimeSeriesExam](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=raSUiKUAAAAJ&citation_for_view=raSUiKUAAAAJ:8k81kl-MbHgC), for systematic evaluation of LLMs and VLMs on their understanding of time series concepts
* [LayerMerge](https://openreview.net/forum?id=7jEz15AsVT&referrer=%5BAuthor%20Console%5D(%2Fgroup%3Fid%3DNeurIPS.cc%2F2025%2FWorkshop%2FER%2FAuthors%23your-submissions)), a modality- and architecture-agnostic depth pruning approach for extreme compression of foundation models.

My research interests lie in:

* Developing pragmatic multimodal foundation models capable of addressing multifaceted challenges across time series, text, images, code, and tabular data. 
